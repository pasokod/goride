                            ...
                            {{--<div id="users-table_filter" class="pull-right"><label>{{ trans('lang.search_by')}}
                                    ...
                                    <div class="form-group">
                                        <input type="search" id="search" class="search form-control"
                                               placeholder="Search" aria-controls="document-table">
                                </label>&nbsp;
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        async function getListData(val) {
            ...
            html = html + '<td class="action-btn"><a id="' + val.id + '" class="doc-revert" name="doc-revert" href="javascript:void(0)"><i class="fa fa-undo"></i></a></td>';
            html = html + '</tr>';
            return html;
        }
        ...
        $(document).on("click", "a[name='doc-revert']", function (e) {
            var id = $(this).attr('id');
            jQuery("#overlay").show();
